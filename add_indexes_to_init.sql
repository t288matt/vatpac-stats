...
-- This file adds the indexes to the init.sql schema
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_flight_summaries_callsign_dep_arr_logon 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_flight_summaries_callsign_completion
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_flights_archive_callsign_altitude_last_updated 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_flights_archive_callsign_altitude_gt1500 
ON flights_archive (callsign, last_updated) 
WHERE altitude > 1500;
