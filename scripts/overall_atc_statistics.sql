-- Overall ATC Communication Statistics
-- 
-- This query shows the overall statistics for all flights combined:
-- "Number of flight data records in contact with ATC" over "Total flight data records"
--
-- Usage:
--   docker exec vatsim_postgres psql -U vatsim_user -d vatsim_data -f scripts/overall_atc_statistics.sql
--
